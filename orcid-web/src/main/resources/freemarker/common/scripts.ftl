...
<#if RequestParameters['angular2']??>
	...
	<script src="${staticCdn}/javascript/angular2/node_modules/core-js/client/shim.min.js"></script>
	
	<script src="${staticCdn}/javascript/angular2/node_modules/zone.js/dist/zone.js"></script>
	<script src="${staticCdn}/javascript/angular2/node_modules/reflect-metadata/Reflect.js"></script>
	
	<script src="${staticCdn}/javascript/angular2/node_modules/rxjs/bundles/Rx.umd.js"></script>
	<script src="${staticCdn}/javascript/angular2/node_modules/@angular/core/bundles/core.umd.js"></script>
	<script src="${staticCdn}/javascript/angular2/node_modules/@angular/common/bundles/common.umd.js"></script>
	<script src="${staticCdn}/javascript/angular2/node_modules/@angular/compiler/bundles/compiler.umd.js"></script>
	<script src="${staticCdn}/javascript/angular2/node_modules/@angular/platform-browser/bundles/platform-browser.umd.js"></script>
	<script src="${staticCdn}/javascript/angular2/node_modules/@angular/platform-browser-dynamic/bundles/platform-browser-dynamic.umd.js"></script>
	
	<script src="${staticCdn}/javascript/angular2/components/orcid.component.js"></script>
	<script src="${staticCdn}/javascript/angular2/modules/orcid.module.js"></script>
	<script src="${staticCdn}/javascript/angular2/orcid.main.js"></script>
</#if>
